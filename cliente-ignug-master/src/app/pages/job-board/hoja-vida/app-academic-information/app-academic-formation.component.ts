...
selectAcademicFormation(academicFormation:AcademicFormation): void {
    if (academicFormation) {
        ...
        this.academicFormationForm.controls['institution_id'].setValue(academicFormation.institution.id);
        this.academicFormationForm.controls['career_id'].setValue(academicFormation.career.id);
